...
#wgs_map=${thousand_g_dir}chrMT_1kg_norm_decomposed_firstAlt.map
#wgs_ped=${thousand_g_dir}chrMT_1kg_norm_decomposed_firstAlt.ped
#wgs_vcf=${thousand_g_dir}chrMT_1kg_norm_decomposed_firstAlt.vcf.gz
#typ_map=${strand_dir}chrMT_1kg_${MtPlatforms}.map
#typ_ped=${strand_dir}chrMT_1kg_${MtPlatforms}.ped
#typ_vcf=${strand_dir}chrMT_1kg_${MtPlatforms}.vcf.gz
#imp_map=${strand_dir}chrMT_1kg_${MtPlatforms}_imputed.map
#imp_ped=${strand_dir}chrMT_1kg_${MtPlatforms}_imputed.ped
#imp_vcf=${strand_dir}chrMT_1kg_${MtPlatforms}_imputed.vcf
#imp_info=${strand_dir}chrMT_1kg_${MtPlatforms}_imputed_info
#
#output=${strand_dir}chrMT_1kg_${MtPlatforms}_mtImputed_QC.html
#
#rwd = `pwd`/
#output_dir=${thousand_g_dir}${MtPlatforms}/
#info_cut='0'