...
WGS_VCF=${WK_DIR}MitoImpute/data/ADNI_REDO_n757/WGS/VCF/adni_mito_genomes_180214_fixed.vcf.gz # Whole genome resequence (ADNI 3)
TYP_VCF=${WK_DIR}MitoImpute/data/ADNI_REDO_n757/GENOTYPED/VCF/mito_snps_rcrs_ed.vcf.gz # Genotyped data (ADNI 1)
#IMP_VCF=${WK_DIR}
...
#TYP_n757=${WK_DIR}MitoImpute/data/ADNI_REDO_n757/GENOTYPED/VCF/mito_snps_rcrs_ed_n757.vcf.gz
#WGS_n757=${WK_DIR}MitoImpute/data/ADNI_REDO_n757/WGS/VCF/adni_mito_genomes_180214_fixed_n757.vcf.gz

TYP_n757=${TYP_VCF}
WGS_n757=${WGS_VCF}

#bcftools view -S ~/GitCode/MitoImputePrep/metadata/ADNI_samples_BOTH.txt ${TYP_VCF} | bcftools +fill-tags -Oz -o ${TYP_n757}
#bcftools index ${TYP_n757}
#
#bcftools view -S ~/GitCode/MitoImputePrep/metadata/ADNI_samples_BOTH_reseq.txt ${WGS_VCF} | bcftools +fill-tags -Oz -o ${WGS_n757}
#bcftools index ${WGS_n757}

# FILTER VCF TO CONTAIN ONLY SNVs 
echo
echo "FILTER VCF TO CONTAIN ONLY SNVs"
TYP_n757_tmp=${WK_DIR}MitoImpute/data/ADNI_REDO_n757/GENOTYPED/VCF/mito_snps_rcrs_ed_n757_tmp.vcf.gz
WGS_n757_tmp=${WK_DIR}MitoImpute/data/ADNI_REDO_n757/WGS/VCF/adni_mito_genomes_180214_fixed_n757_tmp.vcf.gz
...
#bcftools annotate -x INFO,^FORMAT/GT ${WGS_n757} | bcftools norm --check-ref s -f ${REF26} -m - | bcftools view -V indels,mnps | bcftools +fill-tags -Oz -o ${WGS_n757_biallelic}
#bcftools annotate -x INFO,^FORMAT/GT ${TYP_n757} | bcftools norm --check-ref s -f ${REFMT} -m - | bcftools view -V indels,mnps | bcftools +fill-tags -Oz -o ${TYP_n757_biallelic}

bcftools annotate -x INFO,^FORMAT/GT ${WGS_n757} | bcftools norm --check-ref s -f ${REF26} | bcftools view -V indels,mnps | bcftools norm -m + | bcftools +fill-tags -Oz -o ${WGS_n757_tmp}
bcftools annotate -x INFO,^FORMAT/GT ${TYP_n757} | bcftools norm --check-ref s -f ${REFMT} | bcftools view -V indels,mnps | bcftools norm -m + | bcftools +fill-tags -Oz -o ${TYP_n757_tmp}

bcftools index ${WGS_n757_tmp}
bcftools index ${TYP_n757_tmp}
...
TYP_n757_biallelic=${WK_DIR}MitoImpute/data/ADNI_REDO_n757/GENOTYPED/VCF/mito_snps_rcrs_ed_n757_biallelic.vcf.gz
#WGS_n757_biallelic=${WK_DIR}MitoImpute/data/ADNI_REDO_n757/WGS/VCF/adni_mito_genomes_180214_fixed_n757_biallelic.vcf.gz

#vt decompose ${WGS_n757_tmp} | bcftools +fill-tags -Oz -o ${WGS_n757_biallelic}
vt decompose ${TYP_n757_tmp} | bcftools +fill-tags -Oz -o ${TYP_n757_biallelic}

#bcftools index ${WGS_n757_biallelic}
bcftools index ${TYP_n757_biallelic}

# RELABEL WGS TO ADNI1 SAMPLE IDs
samples_csv=~/GitCode/MitoImputePrep/metadata/ADNI_samples_BOTH.csv
WGS_relab=${WK_DIR}MitoImpute/data/ADNI_REDO_n757/WGS/VCF/adni_mito_genomes_180214_fixed_n757_biallelic_relabelled.vcf

#python ~/GitCode/MitoImputePrep/scripts/PYTHON/fix_vcf_names.py -i ${TYP_n757_biallelic} -o ${WGS_relab} -c ${samples_csv} -v
...
#WGS_SAMPLE=${WK_DIR}MitoImpute/data/ADNI_REDO_n757/WGS/INFO/adni_mito_genomes_180214_fixed_n757_biallelic_relabelled_sampleID.txt
#WGS_SEX_SAMPLE=${WK_DIR}MitoImpute/data/ADNI_REDO_n757/WGS/INFO/adni_mito_genomes_180214_fixed_n757_biallelic_relabelled_sampleID_sex.txt
TYP_SAMPLE=${WK_DIR}MitoImpute/data/ADNI_REDO_n757/GENOTYPED/INFO/mito_snps_rcrs_ed_n757_biallelic_sampleID.txt
TYP_SEX_SAMPLE=${WK_DIR}MitoImpute/data/ADNI_REDO_n757/GENOTYPED/INFO/mito_snps_rcrs_ed_n757_biallelic_sampleID_sex.txt
...
bcftools query -l ${TYP_n757_biallelic} > ${TYP_SAMPLE}
...
#WGS_PLINK=${WK_DIR}MitoImpute/data/ADNI_REDO_n757/WGS/PLINK/adni_mito_genomes_180214_fixed_n757_biallelic_relabelled
TYP_PLINK=${WK_DIR}MitoImpute/data/ADNI_REDO_n757/GENOTYPED/VCF/mito_snps_rcrs_ed_n757_biallelic
#plink1.9 --vcf ${WGS_relab} --recode --double-id --keep-allele-order --out ${WGS_PLINK}
plink1.9 --vcf ${TYP_n757_biallelic} --recode --double-id --keep-allele-order --out ${TYP_PLINK}

# GENERATE GEN FILES
echo 
echo "GENERATE GEN AND SAMPLE FILES"
#WGS_GEN_OUT=${WK_DIR}MitoImpute/data/ADNI_REDO_n757/WGS/HAP_LEGEND_GEN/adni_mito_genomes_180214_fixed_n757_biallelic_relabelled
TYP_GEN_OUT=${WK_DIR}MitoImpute/data/ADNI_REDO_n757/GENOTYPED/HAP_LEGEND_GEN/mito_snps_rcrs_ed_n757_biallelic


#bcftools convert --gensample ${WGS_GEN_OUT} ${WGS_relab} --sex ${WGS_SEX_SAMPLE}
bcftools convert --gensample ${TYP_GEN_OUT} ${TYP_n757_biallelic} --sex ${TYP_SEX_SAMPLE}
...
out_dir=${WK_DIR}MitoImpute/data/ADNI_REDO_n757/IMPUTED/${REFpanel}/IMPUTE2/
...
#impute2_out=${WK_DIR}MitoImpute/data/ADNI_REDO_n757/IMPUTED/IMPUTE2/${REFpanel}/MitoImpute_ADNI_imputed
