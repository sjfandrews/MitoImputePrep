...
BFILE=${WK_DIR}MitoImpute/data/ADNI_12GO_REDO/GENOTYPED/PLINK/ORIGINALS/${ADNI_PREFIX}
OUT_VCF=${WK_DIR}MitoImpute/data/ADNI_12GO_REDO/GENOTYPED/VCF/${ADNI_PREFIX}
...
TYP_SAMPLE=${WK_DIR}MitoImpute/data/ADNI_12GO_REDO/GENOTYPED/INFO/${ADNI_PREFIX}_samples.txt
TYP_SEX_SAMPLE=${WK_DIR}MitoImpute/data/ADNI_12GO_REDO/GENOTYPED/INFO/${ADNI_PREFIX}_samples_sex.txt
...
TYP_PLINK=${WK_DIR}MitoImpute/data/ADNI_12GO_REDO/GENOTYPED/PLINK/${ADNI_PREFIX}

#plink1.9 --bfile ${BFILE} --recode --double-id --keep-allele-order --out ${TYP_PLINK}
plink1.9 --vcf ${ADNI_12GO_VCF} --recode --double-id --keep-allele-order --out ${TYP_PLINK}

# GENERATE GEN FILES
echo 
echo "GENERATE GEN AND SAMPLE FILES"
TYP_GEN_OUT=${WK_DIR}MitoImpute/data/ADNI_12GO_REDO/GENOTYPED/HAP_LEGEND_GEN/${ADNI_PREFIX}
...
out_dir=${WK_DIR}MitoImpute/data/ADNI_12GO_REDO/IMPUTED/${REFpanel}/IMPUTE2/
...
#impute2_out=${WK_DIR}MitoImpute/data/ADNI_12GO_REDO/IMPUTED/IMPUTE2/${REFpanel}/MitoImpute_ADNI_imputed
