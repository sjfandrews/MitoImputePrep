...
plot_dir = "~/Desktop/MitoImpute_plots/"
...
ggplot(maf_tables, aes(x = sub_experiment, y = typed_match)) +
  geom_violin(fill = "#feb600", na.rm = T, lwd = rel(1/3)) +
  geom_boxplot(width = rel(0.25), notch = T, fill = "#ea4e3c", na.rm = T, outlier.colour = "#802428", lwd = rel(1/3)) +
...
ggsave(paste0(plot_dir, "HiMC_MAF_typedMatch_boxplot.png"), bg = "transparent", width = 297, height = 210, units = "mm", dpi = 300)
...
ggplot(maf_tables, aes(x = sub_experiment, y = imputed_match)) +
  ...
  theme(axis.text.x = element_text(hjust = 1.0, vjust = 1.0, angle = 45, size = rel(1.0)),
        ...
        panel.background = element_rect(fill = "transparent",colour = NA),
        plot.background = element_rect(fill = "transparent",colour = NA))
ggsave(paste0(plot_dir, "HiMC_MAF_imputedMatch_boxplot.png"), bg = "transparent", width = 297, height = 210, units = "mm", dpi = 300)
...
ggplot(khap_tables, aes(x = sub_experiment, y = typed_match)) +
  ...
  theme(axis.text.x = element_text(hjust = 1.0, vjust = 1.0, angle = 45, size = rel(1.0)),
        ...
        panel.background = element_rect(fill = "transparent",colour = NA),
        plot.background = element_rect(fill = "transparent",colour = NA))
ggsave(paste0(plot_dir, "HiMC_kHAP_typedMatch_boxplot.png"), bg = "transparent", width = 297, height = 210, units = "mm", dpi = 300)
...
ggplot(khap_tables, aes(x = sub_experiment, y = imputed_match)) +
  ...
  theme(axis.text.x = element_text(hjust = 1.0, vjust = 1.0, angle = 45, size = rel(1.0)),
        ...
        panel.background = element_rect(fill = "transparent",colour = NA),
        plot.background = element_rect(fill = "transparent",colour = NA))
ggsave(paste0(plot_dir, "HiMC_kHAP_imputedMatch_boxplot.png"), bg = "transparent", width = 297, height = 210, units = "mm", dpi = 300)
...
ggplot(mcmc_tables, aes(x = sub_experiment, y = typed_match)) +
  ...
  theme(axis.text.x = element_text(hjust = 1.0, vjust = 1.0, angle = 45, size = rel(1.0)),
        ...
        panel.background = element_rect(fill = "transparent",colour = NA),
        plot.background = element_rect(fill = "transparent",colour = NA))
ggsave(paste0(plot_dir, "HiMC_MCMC_typedMatch_boxplot.png"), bg = "transparent", width = 297, height = 210, units = "mm", dpi = 300)
...
ggplot(mcmc_tables, aes(x = sub_experiment, y = imputed_match)) +
  ...
  theme(axis.text.x = element_text(hjust = 1.0, vjust = 1.0, angle = 45, size = rel(1.0)),
        ...
        panel.background = element_rect(fill = "transparent",colour = NA),
        plot.background = element_rect(fill = "transparent",colour = NA))
ggsave(paste0(plot_dir, "HiMC_MCMC_imputedMatch_boxplot.png"), bg = "transparent", width = 297, height = 210, units = "mm", dpi = 300)
