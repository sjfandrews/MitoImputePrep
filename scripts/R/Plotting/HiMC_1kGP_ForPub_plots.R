...
## FOR PUBLICATION:
# MAF
MAF_imp = read.csv("/Volumes/TimMcInerney/MitoImpute/analyses/concordance/HiMC/ConcordanceTables_MAF_Experiments_HiMC_COMBINED.csv", header = T) # LOAD INFO FILE
...
# KHAP
KHAP_imp = read.csv("/Volumes/TimMcInerney/MitoImpute/analyses/concordance/HiMC/ConcordanceTables_kHAP_Experiments_HiMC_COMBINED.csv", header = T) # LOAD INFO FILE
...
# MCMC
MCMC_imp = read.csv("/Volumes/TimMcInerney/MitoImpute/analyses/concordance/HiMC/ConcordanceTables_MCMC_Experiments_HiMC_COMBINED.csv", header = T) # LOAD INFO FILE
